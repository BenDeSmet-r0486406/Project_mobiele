...
export default class GameScreen extends React.Component {
    ...
    componentDidMount(){
        alert(opdrachtenData.graad1.length + " " + opdrachtenData.graad2.length  + " " + opdrachtenData.graad3.length + " " + opdrachtenData.graad4.length  + " " + opdrachtenData.graad5.length)
    }
